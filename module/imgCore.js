class imgClass {          //Class Model Memanggil seluruh function pada Class Car
    ...
    statusAwal(Q,W,R) {
        ...
        if (elemKondisi.value !== "satuGelas"){  
            ...
            document.getElementById("img").src = "https://github.com/dnrahmath/algoritmaAer/blob/master/images/imgFrame/duaGelas/duaGelas-Frame0000.png";
            ...
            document.getElementById("img").src = "https://github.com/dnrahmath/algoritmaAer/blob/master/images/imgFrame/satuGelas/satuGelas-Frame0000.png";
    ...
    frameBerjalan() {
        ...
        function frameLooping() {
            ...
            interval = setTimeout(function() {
                ...
                if (elemKondisi.value !== "satuGelas"){
                    document.getElementById("img").src = "https://github.com/dnrahmath/algoritmaAer/blob/master/images/imgFrame/duaGelas/duaGelas-Frame"+i+".png";
                    document.getElementById("frameNumber").innerHTML = i;
                }
                else {
                    document.getElementById("img").src = "https://github.com/dnrahmath/algoritmaAer/blob/master/images/imgFrame/satuGelas/satuGelas-Frame"+i+".png";
                    document.getElementById("frameNumber").innerHTML = i;
                }
